...
abstract contract callDiam{
    ...
    function getAdmin()virtual public  view  returns(address);
    function getDonor(uint256  _id)virtual public view;
    function changeAdmin(address newAdmin)virtual  public ;
    function getDonorByID(uint256  _id)virtual public  view returns (uint256);
